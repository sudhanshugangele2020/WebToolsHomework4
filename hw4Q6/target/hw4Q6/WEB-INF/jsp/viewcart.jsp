...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <ul class="navbar-nav" >
    ...
    <li class="nav-item ">
      <a class="nav-link" href="WEB-INF/jsp/music.jsp">Music</a>
    </li>
    <li class="nav-item " >
      <a class="nav-link " href="WEB-INF/jsp/computers.jsp">Computers</a>
    </li>
	...
	<br/>
		<form method ="post" action="viewcart" id = "cartform">
			<c:choose>
